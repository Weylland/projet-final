...
<main class="h-screen w-screen flex justify-center insc-main">
    <div id="form-cont" class="w-3/4 flex flex-col items-center">
        <div class="w-full h-1/6 mb-10 flex items-center align-center justify-center">
            <h1 class="font-mont font-bold text-4xl" >Modification des données</h1>
        </div>
        ...
        <form action="../systeme/update.php" method="POST" class="w-5/6 h-4/6"> <!-- J'appelle le fichier fonction de l'inscription -->
                            ...
                            <div class="flex flex-col justify-end w-4/12 h-10 mb-6 relative font-quick mr-10">
                                <input 
                                    class=" 
                                        ...
                                        bg-transparent
                                        z-10
                                    " type="text" id="nom" name="nom" placeholder="Nom :" value="<?= $_SESSION['nom']?>" required>
                                <label 
                                    class="
                                        transition-all 
                                        text-gray-600 
                            ...
                            <div class="flex flex-col justify-end w-6/12 h-10 mb-6 relative font-quick mr-10">
                                <input 
                                    class=" 
                                        ...
                                        bg-transparent
                                        z-10
                                    " type="text" id="prenom" name="prenom" placeholder="Prénom :" value="<?= $_SESSION['prenom']?>" required>
                                <label 
                                    class="
                                        transition-all 
                                        text-gray-600 
                            ...
                            <div class="flex flex-col justify-end w-2/12 h-10 mb-6 relative font-quick">
                                <input 
                                    class=" 
                                        ...
                                        bg-transparent
                                        z-10
                                    " type="number" id="age" name="age" placeholder="Age :" value="<?= $_SESSION['age']?>" required>
                                <label 
                                    class="
                                        transition-all 
                                        text-gray-600 
                            ...
                            <div class="flex w-6/12 flex-col justify-end h-10 mb-6 relative font-quick mr-20">
                                <input 
                                    class=" 
                                        ...
                                        bg-transparent
                                        z-10
                                    " type="mail" id="mail" name="mail" placeholder="Email :" value="<?= $_SESSION['mail']?>" required>
                                <label 
                                    class="
                                        transition-all 
                                        text-gray-600 
                            ...
                            <div class="flex flex-col justify-end w-3/12 h-10 mb-6 relative font-quick mr-10">
                                <input 
                                    class=" 
                                        ...
                                        bg-transparent
                                        z-10
                                    " type="number" id="taille" name="taille" placeholder="Taille en cm :" value="<?= $_SESSION['taille']?>" required>
                                <label 
                                    class="
                                        transition-all 
                                        text-gray-600 
                            ...
                            <div class="flex flex-col justify-end w-3/12 h-10 mb-6 relative font-quick mr-10">
                                <input 
                                    class=" 
                                        ...
                                        bg-transparent
                                        z-10
                                    " type="number" id="poids" name="poids" placeholder="Poids :" value="<?= $_SESSION['poid']?>" required>
                                <label 
                                    class="
                                        transition-all 
                                        text-gray-600 
